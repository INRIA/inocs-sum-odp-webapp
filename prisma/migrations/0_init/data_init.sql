...
INSERT INTO `users` (`id`, `name`, `email`, `role_id`, `email_verified_at`, `password`, `picture`, `location`, `phone`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'ODP admin', 'odp.admin@yopmail.com', 1, NULL, '$2y$10$QMeJTMNLcJLZZZ1tgA1vz.dIFakyc2snJUER/nAYxb6XKI/UrBHJa', NULL, NULL, NULL, NULL, '2025-06-27 06:42:33', '2025-06-27 06:42:33');
